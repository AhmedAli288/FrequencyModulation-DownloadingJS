...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../AppData/Roaming/nvm/v16.8.0/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"../../AppData/Roaming/nvm/v16.8.0/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"../../AppData/Roaming/nvm/v16.8.0/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/styles.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../AppData/Roaming/nvm/v16.8.0/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/pizzicato-recorder/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"viper.mp3":[function(require,module,exports) {
module.exports = "/viper.c823f26e.mp3";
},{}],"src/test.js":[function(require,module,exports) {
"use strict";

require("./styles.css");

var _pizzicatoRecorder = _interopRequireDefault(require("pizzicato-recorder"));

var _pizzicato = _interopRequireDefault(require("pizzicato"));

var _viper = _interopRequireDefault(require("../viper.mp3"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _pizzicatoRecorder.default)(_pizzicato.default);
...
myAudio.addEventListener("play", function () {
  if (!audioCtx) {
    ...
    biquadFilter.type = "highpass"; // biquadFilter.frequency.value = 1000;
    // biquadFilter.detune.value = 15360; //[-153600, 153600]

    biquadFilter.frequency.setValueAtTime(40000, audioCtx.currentTime); // connect the AudioBufferSourceNode to the destination
    ...
    button.onclick = function () {
      ...
      if (active === "false") {
        ...
        biquadFilter.connect(audioCtx.destination); // Pizzicato.Recorder.start({ mute: false });
        // source.start()
      } else if (active === "true") {
        button.setAttribute("data-active", "false");
        button.innerHTML = "Add compression"; // Pizzicato.Recorder.stop("wav", handleAudio);

        source.disconnect(biquadFilter); // compressor.disconnect(audioCtx.destination);
...
// <pre></pre>
// `;
},{"./styles.css":"src/styles.css","pizzicato-recorder":"node_modules/pizzicato-recorder/index.js","pizzicato":"node_modules/pizzicato/distr/Pizzicato.min.js","../viper.mp3":"viper.mp3"}],"../../AppData/Roaming/nvm/v16.8.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../AppData/Roaming/nvm/v16.8.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/test.js"], null)
