...
},{"_css_loader":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/pizzicato-recorder/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"src/tests.js":[function(require,module,exports) {
"use strict";
...
var source = offlineCtx.createBufferSource(); // define constants for dom nodes

var pre = document.querySelector("pre");
var myScript = document.querySelector("script");
var play = document.querySelector(".play");
var stop = document.querySelector(".stop"); // use XHR to load an audio track, and
// decodeAudioData to decode it and stick it in a buffer.
// Then we put the buffer into the source

function getData() {
  var request = new XMLHttpRequest();
  request.open("GET", _viper.default, true);
  ...
  request.onload = function () {
    ...
    audioCtx.decodeAudioData(audioData, function (buffer) {
      ...
      biquadFilter.frequency.setValueAtTime(20000, offlineCtx.currentTime); // source.disconnect(audioCtx.destination);

      source.connect(biquadFilter); // biquadFilter.connect(audioCtx.destination);
      ...
      offlineCtx.startRendering().then(function (renderedBuffer) {
        ...
        console.log("buff", renderedBuffer.getChannelData(1)); // song.connect(audioCtx.destination);

        song.start();
      }).catch(function (err) {
        console.log("Rendering failed: " + err); // Note: The promise should reject when startRendering is called a second time on an OfflineAudioContext
      });
    });
  };

  request.send(); // function handleAudio(file, fileType) {
  //     console.log("Stop");
...
},{"./styles.css":"src/styles.css","pizzicato-recorder":"node_modules/pizzicato-recorder/index.js","pizzicato":"node_modules/pizzicato/distr/Pizzicato.min.js","../viper.mp3":"viper.mp3"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/tests.js"], null)
//# sourceMappingURL=/tests.c8bee05d.js.map