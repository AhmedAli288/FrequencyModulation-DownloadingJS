...
document.addEventListener("click", function () {
  ...
  var sound = new _pizzicato.default.Sound(_viper.default, function () {
    sound.addEffect(delay);
    sound.play();
  });
  var delay = new _pizzicato.default.Effects.HighPassFilter({
    frequency: 22000,
    peak: 10
  }); // await sleep(2000);
  // sound.connect(dest);
...
},{}]},{},["../../AppData/Roaming/nvm/v16.8.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.js"], null)
